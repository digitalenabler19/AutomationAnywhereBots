...
public final class GetCurrentTimeConversionCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(GetCurrentTimeConversionCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    GetCurrentTimeConversion command = new GetCurrentTimeConversion();
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action((ZonedDateTime)convertedParameters.get("source"),(String)convertedParameters.get("tm")));
