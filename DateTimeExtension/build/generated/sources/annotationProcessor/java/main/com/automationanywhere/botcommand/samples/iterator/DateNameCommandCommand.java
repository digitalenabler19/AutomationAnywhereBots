...
public final class DateNameCommandCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(DateNameCommandCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    DateNameCommand command = new DateNameCommand();
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action((ZonedDateTime)convertedParameters.get("source")));
